...
CaPilot's Linux builds target **stock Ubuntu 20.04 and newer** — glibc 2.31 and
...
Because the CaPilot main process loads node-pty at startup, that failure crashes the
