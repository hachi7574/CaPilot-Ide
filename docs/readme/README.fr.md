<h1 align="center">
  <a href="https://onOrca.dev"><img src="../../resources/build/icon.png" alt="CaPilot" width="64" valign="middle" /></a> CaPilot
</h1>
...
<p align="center">
  ...
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="Rejoindre le Discord CaPilot" /></a>
  <a href="https://x.com/orca_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="Suivre CaPilot sur X" /></a>
...
<h3 align="center"><a href="https://onorca.dev/download"><ins>Télécharger CaPilot</ins></a></h3>
...
<p align="center">
  <img src="../assets/readme-hero.jpg" alt="Application de bureau CaPilot exécutant des agents dans des worktrees parallèles, avec l'app companion mobile CaPilot dans le coin" width="960" />
</p>
...
<td width="50%">
  <a href="https://www.onorca.dev/docs/mobile"><picture><source srcset="../assets/feature-wall/mobile-companion-app-showcase.gif" type="image/gif"><img src="../assets/feature-wall/mobile-companion-app-showcase.jpg" alt="CaPilot desktop avec l'app companion mobile" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.onorca.dev/docs/review/linear"><picture><source srcset="../assets/feature-wall/github-linear.gif" type="image/gif"><img src="../assets/feature-wall/github-linear.jpg" alt="Workflows GitHub et Linear dans CaPilot" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
Posez des commentaires sur n'importe quelle ligne de diff et renvoyez-les à l'agent — review, édition et commit sans quitter CaPilot.
...
Les agents pilotent aussi CaPilot — scriptez n'importe quel workflow avec `capilot worktree create`, `snapshot`, `click` et `fill`.

[Docs →](https://www.onorca.dev/docs/cli/overview)

</td>
<td width="50%">
  <a href="https://www.onorca.dev/docs/cli/overview"><picture><source srcset="../assets/feature-wall/orca-cli.gif" type="image/gif"><img src="../assets/feature-wall/orca-cli.jpg" alt="Scripter CaPilot depuis la CLI" width="100%" /></picture></a>
</td>
</tr>
</table>
...
Fonctionne avec **n'importe quel agent CLI** — s'il tourne dans un terminal, il tourne dans CaPilot.
...
- Vous lancez `capilot serve` sur un serveur Linux headless ? Consultez le [guide serveur Linux headless](../reference/headless-linux-server.md).
...
# Arch Linux (AUR) — ou stably-capilot-git pour compiler depuis les sources
yay -S stably-capilot-bin
```
...
- **WeChat :** Scannez pour rejoindre le groupe WeChat 7 de la communauté CaPilot.

  <img src="../assets/wechat-qr-group7.jpg" alt="QR code WeChat groupe 7 de la communauté CaPilot" width="160" />

- **Feedback &amp; idées :** On ship vite. Il manque quelque chose ? [Demandez une feature](https://github.com/stablyai/orca/issues).
- **Confidentialité :** Voir la [doc confidentialité &amp; télémétrie](https://www.onorca.dev/docs/telemetry) pour ce qu'CaPilot collecte en anonyme et comment désactiver la télémétrie.
...
<a href="https://github.com/stablyai/orca/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=stablyai/orca" alt="Contributeurs CaPilot" />
</a>
...
CaPilot est libre et open source sous la [licence MIT](../../LICENSE).
