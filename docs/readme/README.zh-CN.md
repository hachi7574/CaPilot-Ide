...
<p align="center">
  ...
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="加入 CaPilot Discord" /></a>
  <a href="https://x.com/orca_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="在 X 上关注 CaPilot" /></a>
...
<h3 align="center"><a href="https://onorca.dev/download"><ins>下载 CaPilot</ins></a></h3>

<p align="center">
  <img src="../assets/readme-hero.jpg" alt="CaPilot 桌面应用在并行 worktree 中运行智能体，角落里是 CaPilot 移动 companion 应用" width="960" />
</p>
...
<td width="50%">
  <a href="https://www.onorca.dev/docs/mobile"><picture><source srcset="../assets/feature-wall/mobile-companion-app-showcase.gif" type="image/gif"><img src="../assets/feature-wall/mobile-companion-app-showcase.jpg" alt="CaPilot 桌面端与移动 companion 应用" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.onorca.dev/docs/review/linear"><picture><source srcset="../assets/feature-wall/github-linear.gif" type="image/gif"><img src="../assets/feature-wall/github-linear.jpg" alt="CaPilot 中的 GitHub 与 Linear 任务工作流" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
在任意 diff 行上添加评论并发回给智能体 — 评审、编辑、提交，全程无需离开 CaPilot。
...
智能体也能驱动 CaPilot — 用 `capilot worktree create`、`snapshot`、`click` 和 `fill` 把每个工作流脚本化。

[文档 →](https://www.onorca.dev/docs/cli/overview)

</td>
<td width="50%">
  <a href="https://www.onorca.dev/docs/cli/overview"><picture><source srcset="../assets/feature-wall/orca-cli.gif" type="image/gif"><img src="../assets/feature-wall/orca-cli.jpg" alt="从 CLI 脚本化 CaPilot" width="100%" /></picture></a>
</td>
</tr>
</table>
...
适配**任何 CLI 智能体** — 只要能在终端里运行，就能在 CaPilot 里运行。
...
- **微信:** 扫码加入 CaPilot 社区微信第 7 群。

  <img src="../assets/wechat-qr-group7.jpg" alt="CaPilot 社区微信第 7 群二维码" width="160" />

- **反馈与想法:** 我们发布很快。缺少什么功能？[提交功能请求](https://github.com/stablyai/orca/issues)。
- **隐私:** 查看[隐私与遥测文档](https://www.onorca.dev/docs/telemetry)，了解 CaPilot 收集哪些匿名使用数据以及如何退出。
...
<a href="https://github.com/stablyai/orca/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=stablyai/orca" alt="CaPilot 贡献者" />
</a>

## 许可证

CaPilot 是自由且开源的软件，遵循 [MIT 许可证](../../LICENSE)。
