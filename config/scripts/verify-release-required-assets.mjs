...
export function getRequiredReleaseAssetNames(tag) {
  ...
  return [
    ...
    `capilot-ide_${version}_amd64.deb`,
    `capilot-ide_${version}_arm64.deb`,
    `capilot-ide-${version}.x86_64.rpm`,
    `capilot-ide-${version}.aarch64.rpm`,
    'capilot-windows-setup.exe',
    'capilot-windows-setup.exe.blockmap',
    `CaPilot-${version}-mac.zip`,
    `CaPilot-${version}-mac.zip.blockmap`,
    `CaPilot-${version}-arm64-mac.zip`,
    `CaPilot-${version}-arm64-mac.zip.blockmap`,
    'capilot-macos-x64.dmg',
    'capilot-macos-x64.dmg.blockmap',
    'capilot-macos-arm64.dmg',
    'capilot-macos-arm64.dmg.blockmap'
  ]
}
