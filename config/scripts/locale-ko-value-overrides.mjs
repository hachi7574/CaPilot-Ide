...
export const KO_VALUE_OVERRIDES = {
  ...
  'Add CaPilot attribution to commits, PRs, and issues.': '커밋, PR 및 이슈에 CaPilot 속성을 추가합니다.',
  ...
  'CLI skill': 'CLI 스킬',
  'CaPilot CLI skill': 'CaPilot CLI 스킬',
  ...
  'Review inactive workspaces before deleting their local files and CaPilot state.':
    '로컬 파일과 CaPilot 상태를 삭제하기 전에 비활성 워크스페이스를 확인하세요.',
  ...
  'Install the CaPilot skill so agents know to use the CaPilot CLI.':
    '에이전트가 CaPilot CLI를 사용하도록 CaPilot 스킬을 설치하세요.',
