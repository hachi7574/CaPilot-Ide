...
if (process.platform !== 'win32') {
  ...
  // continue toward a Windows package whose declared capilot.exe does not exist.
  throw new Error(
...
if (!compilerPath) {
  throw new Error('Unable to find the .NET Framework C# compiler required for capilot.exe.')
}
...
function defaultOutputPath(projectRoot) {
  return join(projectRoot, 'native', 'windows-cli-launcher', '.build', 'capilot.exe')
}
