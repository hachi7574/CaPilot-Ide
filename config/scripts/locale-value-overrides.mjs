...
export const LOCALE_VALUE_OVERRIDES = {
  es: {
    'Explore CaPilot': 'Explorar CaPilot',
  ...
  zh: {
    ...
    'Connect to CaPilot': '连接到 CaPilot',
    'USB Devices': 'USB 设备',
  ...
  ja: {
    ...
    'Connect to CaPilot': 'CaPilot に接続',
    ...
    'Kill all': 'すべて強制終了',
    'kill all': 'すべて終了',
    'Collapse CaPilot': 'CaPilot を折りたたむ',
