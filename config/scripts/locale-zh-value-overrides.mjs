...
export const ZH_VALUE_OVERRIDES = {
  ...
  'CaPilot IDE': 'CaPilot IDE',
  'CaPilot first': 'CaPilot 优先',
  'CaPilot Mobile': 'CaPilot Mobile',
  'CaPilot logo': 'CaPilot 标志',
  'Enjoying CaPilot?': '喜欢 CaPilot 吗？',
  'Get to know CaPilot': '了解 CaPilot',
  'Expand CaPilot': '展开 CaPilot',
  'Support CaPilot': '支持 CaPilot',
  'Restarting CaPilot…': '正在重启 CaPilot…',
  'CaPilot Attribution': 'CaPilot 归因',
  'Show CaPilot Mobile Button': '显示 CaPilot Mobile 按钮',
  ...
  "Give agents direct access to CaPilot's browser so they can test pages, capture screenshots, and act on what they see.":
    '让代理直接访问 CaPilot 的浏览器，以便测试页面、捕获屏幕截图并根据所见内容执行操作。',
  ...
  'from CaPilot. It is still on your disk.': '来自 CaPilot。它仍保留在您的磁盘上。',
