/**
 * Builds the exact bytes CaPilot writes into an interactive shell to deliver and
...
export type StartupCommandSubmissionOptions = {
  ...
  submit: string
  /** Whether the target line editor has bracketed-paste mode active (CaPilot's
