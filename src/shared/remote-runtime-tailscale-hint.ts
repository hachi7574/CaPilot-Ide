...
const REMOTE_RUNTIME_UNREACHABLE_RE =
  /could not connect to the remote capilot runtime|remote capilot runtime closed the connection|timed out (?:waiting for|while connecting to) the remote capilot runtime/i
