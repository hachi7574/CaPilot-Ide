...
describe('skills CLI agent keys', () => {
  ...
  it('covers every agent CaPilot can detect', () => {
  ...
  it("follows CaPilot's own evidence for the two non-obvious mappings", () => {
    ...
    // Why: CaPilot detects trae via `traecli`, which tui-agent-config calls an alias
