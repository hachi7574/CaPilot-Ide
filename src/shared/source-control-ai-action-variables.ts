...
export const SOURCE_CONTROL_ACTION_VARIABLE_INFO = {
  basePrompt: {
    description:
      'CaPilot’s built-in prompt for this action, including the context CaPilot knows how to gather safely.',
    example:
  ...
  firstPrompt: {
    description: 'The first user request that created the CaPilot workspace.',
    example: 'Fix CI and commit the result'
  },
  assistantMessage: {
    description: 'The initial agent response, when CaPilot has one available.',
