...
export const FEATURE_WALL_WORKFLOWS: readonly FeatureWallWorkflow[] = [
  {
    ...
    lede: 'CaPilot splits each task into an isolated workspace so agents can run in parallel.',
  ...
  },
  {
    ...
    title: 'Agents',
    meta: 'Agents · Usage · CaPilot CLI',
    lede: 'Run several agents at once, track their progress, and let automation drive CaPilot when it helps.',
  ...
  },
  {
    ...
    lede: 'Bring your terminal setup into CaPilot, then split panes to keep servers, tests, logs, and agents running side by side.',
