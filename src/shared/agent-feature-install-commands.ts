...
export const ORCA_CLI_SKILL_NAME = 'capilot-cli'
export const COMPUTER_USE_SKILL_NAME = 'computer-use'
export const ORCHESTRATION_SKILL_NAME = 'orchestration'
export const EPHEMERAL_VMS_SKILL_NAME = 'capilot-per-workspace-env'
export const ORCA_LINEAR_SKILL_NAME = 'capilot-linear'
