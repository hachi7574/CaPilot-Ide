...
export const FEATURE_WALL_SETUP_STEPS: readonly FeatureWallSetupStep[] = [
  ...
  {
    id: 'browser',
    name: "Use CaPilot's browser",
    subtitle: "Use CaPilot's browser",
    description:
      'Browse your web app without leaving CaPilot. Grab any element and send its exact source and styles to an agent with one click.'
  },
  {
    id: 'notifications',
  ...
  },
  {
    ...
    name: 'Enable CaPilot CLI',
    subtitle: 'Enable CaPilot CLI',
    description:
      'Register the CaPilot shell command and install agent skills for browser, computer, and orchestration workflows.'
  },
  {
    id: 'task-sources',
  ...
  },
  {
    ...
    description:
      'Bring your key repos into CaPilot so you can start agent work without hunting for folders.'
  }
] as const
