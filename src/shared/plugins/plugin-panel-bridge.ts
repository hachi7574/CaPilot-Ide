...
export const PANEL_ACTION_REQUEST_TYPE = 'capilot-panel-action'
export const PANEL_ACTION_RESULT_TYPE = 'capilot-panel-action-result'
export const PANEL_PING_TYPE = 'capilot-panel-ping'
export const PANEL_PONG_TYPE = 'capilot-panel-pong'
export const PLUGIN_PANEL_FRAME_NAME_PREFIX = 'capilot-plugin-panel:'
