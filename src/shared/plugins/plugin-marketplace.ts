...
export const PLUGIN_MARKETPLACE_FILENAME = 'capilot-marketplace.json'
...
export const OFFICIAL_PLUGIN_ID_PREFIX = 'capilot-'
export const OFFICIAL_MARKETPLACE_OWNER = 'stablyai'
export const OFFICIAL_MARKETPLACE_REPOSITORY = 'capilot-plugins'
