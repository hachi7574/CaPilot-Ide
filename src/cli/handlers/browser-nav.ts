...
// round-trip, even when CaPilot is healthy. Give browser.wait an explicit timeout
// budget so slow waits do not get mislabeled as "CaPilot is not running" by the
