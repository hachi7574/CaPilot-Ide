...
export const SERVE_COMMAND_SPECS: CommandSpec[] = [
  {
    path: ['serve'],
    summary: 'Start an CaPilot runtime server without opening a desktop window',
    usage:
    ...
    examples: [
      ...
      'capilot serve --port 6768 --pairing-address 100.64.1.20',
      'capilot serve --pairing-address 100.64.1.20 --mobile-pairing'
    ]
  }
]
