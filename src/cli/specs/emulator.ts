...
export const EMULATOR_COMMAND_SPECS: CommandSpec[] = [
  {
    path: ['emulator', 'list'],
    summary: 'List available/running emulators (CaPilot-managed + raw serve-sim)',
    usage: 'capilot emulator list [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  {
    path: ['emulator', 'devices'],
    summary: 'List all emulator devices/AVDs across iOS and Android',
    usage: 'capilot emulator devices [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  {
    path: ['emulator', 'attach'],
    summary: 'Attach/start helper for a device and make it active for the worktree',
    usage: 'capilot emulator attach [device] [--worktree <selector>] [--focus] [--json]',
  ...
  },
  {
    ...
    usage: 'capilot emulator tap <x> <y> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage: 'capilot emulator type <text> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage: "capilot emulator gesture '<json>' [--device <id>] [--worktree <selector>] [--json]",
  ...
  },
  {
    ...
    usage: 'capilot emulator button <name> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage: 'capilot emulator rotate <orientation> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    path: ['emulator', 'exec'],
    summary:
      'Raw passthrough (e.g. capilot emulator exec --command "tap 0.5 0.7" or "ca-debug blended on")',
    usage: 'capilot emulator exec --command <cmd> [--device <id>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'command', 'device', 'emulator', 'worktree']
  },
  {
    path: ['emulator', 'kill'],
    summary: 'Stop helper for device',
    usage: 'capilot emulator kill [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage:
      'capilot emulator shutdown [--device <id>] [--emulator <id>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'device', 'emulator', 'worktree']
  },
  {
    path: ['emulator', 'install'],
    summary: 'Install an APK onto the target Android device',
    usage: 'capilot emulator install <apkPath> [--reinstall] [--device <id>] [--json]',
  ...
  },
  {
    ...
    usage: 'capilot emulator launch <package> [--activity <name>] [--device <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'capilot emulator permissions <grant|revoke> <package> <permission> [--device <id>] [--json]\n       capilot emulator permissions reset [--device <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'device',
      'emulator',
  ...
  },
  {
    ...
    usage: 'capilot emulator ax [--device <id>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'device', 'emulator', 'worktree']
  },
  {
    path: ['emulator', 'logcat'],
    summary: 'Capture a one-shot logcat dump from the Android device',
    usage: 'capilot emulator logcat [--lines <n>] [--device <id>] [--worktree <selector>] [--json]',
