...
export const LINEAR_COMMAND_SPECS: CommandSpec[] = [
  ...LINEAR_MCP_COMMAND_SPECS,
  {
    ...
    positionalArgs: ['id'],
    examples: [
      'capilot linear issue ENG-123',
      'capilot linear issue --current --comments',
  ...
  },
  {
    ...
    usage: 'capilot linear search <query> [--limit <n>] [--workspace <id>|all] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'limit', 'workspace', 'query'],
    positionalArgs: ['query'],
    examples: ['capilot linear search "auth bug"', 'capilot linear search ENG --workspace all --json']
  },
  {
    path: ['linear', 'team', 'list'],
    summary: 'List connected Linear teams',
    usage: 'capilot linear team list [--workspace <id>|all] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'workspace'],
    examples: ['capilot linear team list --workspace all --json']
  },
  {
    path: ['linear', 'team', 'members'],
    summary: 'List Linear team members',
    usage: 'capilot linear team members --team <key|id> [--workspace <id>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'team', 'workspace'],
    examples: ['capilot linear team members --team ENG --json']
  },
  {
    path: ['linear', 'team', 'states'],
    summary: 'List Linear team workflow states',
    usage: 'capilot linear team states --team <key|id> [--workspace <id>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'team', 'workspace'],
    examples: ['capilot linear team states --team ENG --json']
  },
  {
    path: ['linear', 'team', 'labels'],
    summary: 'List Linear team labels',
    usage: 'capilot linear team labels --team <key|id> [--workspace <id>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'team', 'workspace'],
    examples: ['capilot linear team labels --team ENG --json']
  },
  {
    ...
    examples: [
      'capilot linear project list --query launch --json',
      'capilot linear project list --workspace all --json'
    ]
  },
  {
    path: ['linear', 'list'],
    ...
    examples: ['capilot linear list --filter assigned --limit 10 --json']
  },
  {
    ...
    positionalArgs: ['id'],
    examples: [
      'capilot linear status set ENG-123 --to "In Review"',
      'capilot linear status set --current --to Done --json'
    ]
  },
  {
    ...
    positionalArgs: ['id'],
    examples: ['capilot linear assignee set --current --me --json']
  },
  {
    ...
    positionalArgs: ['id'],
    examples: ['capilot linear assignee clear ENG-123 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'to', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['capilot linear priority set --current --to high --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['capilot linear priority clear ENG-123 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'to', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['capilot linear estimate set --current --to 3 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['capilot linear estimate clear ENG-123 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'to', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['capilot linear due-date set --current --to 2026-06-30 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['capilot linear due-date clear ENG-123 --json']
  },
  {
    ...
    positionalArgs: ['id'],
    examples: ['capilot linear label add --current --label Bug --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'label', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['capilot linear label remove --current --label Bug --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'label', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['capilot linear label set ENG-123 --label Bug --json']
  },
  {
    ...
    positionalArgs: ['id'],
    examples: [
      'capilot linear comment add ENG-123 --body "Implementation is ready for review."',
  ...
  },
  {
    ...
    examples: [
      'capilot linear create --title "Investigate flaky login" --team ENG --project "Launch"',
      'capilot linear create --title "Follow-up bug" --parent-current --body-file - --json'
    ],
