...
const LINEAR_HELP = `capilot linear

Usage: capilot linear <command> [options]
...
Run \`capilot linear <command> --help\` for command-specific usage.`

const LINEAR_ISSUE_HELP = `capilot linear issue

Usage: capilot linear issue [<id>] [--current] [--comments] [--children] [--depth <n>] [--attachments] [--relations] [--activity] [--full] [--workspace <id>] [--json]
...
Options:
  ...
  --pairing-code
  --environment
  --current              Use the current CaPilot worktree linked Linear issue
...
Examples:
  $ capilot linear search "auth bug"
  $ capilot linear search ENG --workspace all --json`

const LINEAR_TEAM_LIST_HELP = `capilot linear team list

Usage: capilot linear team list [--workspace <id>|all] [--json]

List connected Linear teams`

const LINEAR_TEAM_MEMBERS_HELP = `capilot linear team members

Usage: capilot linear team members --team <key|id> [--workspace <id>] [--json]

List Linear team members`

const LINEAR_TEAM_STATES_HELP = `capilot linear team states

Usage: capilot linear team states --team <key|id> [--workspace <id>] [--json]

List Linear team workflow states`

const LINEAR_TEAM_LABELS_HELP = `capilot linear team labels

Usage: capilot linear team labels --team <key|id> [--workspace <id>] [--json]

List Linear team labels`

const LINEAR_PROJECT_LIST_HELP = `capilot linear project list

Usage: capilot linear project list [--query <text>] [--limit <n>] [--workspace <id>|all] [--json]

List connected Linear projects`

const LINEAR_LIST_HELP = `capilot linear list

Usage: capilot linear list [--filter assigned|created|all|completed|open] [--team <key|id>] [--limit <n>] [--workspace <id>|all] [--json]
