...
const PLUGIN_KEY = 'capilot-samples.demo'
const WORKTREE_ID = 'repo-id::/Users/private/capilot'
...
function createServices(): PluginHostServices {
  return {
    resolveActiveWorktreeContext: vi.fn().mockResolvedValue({
      ...
      branch: 'main',
      displayName: 'CaPilot',
      path: '/Users/private/capilot'
    }),
    listWorktreeTerminals: vi
      .fn()
      .mockResolvedValue([{ id: TERMINAL_ID, title: '/home/private/capilot' }]),
