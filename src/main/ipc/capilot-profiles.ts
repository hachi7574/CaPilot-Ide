...
} from '../capilot-profiles/profile-index-store'
import {
  cloudSessionIdentity,
  recordCloudSessionIdentityMutation
} from '../capilot-profiles/profile-cloud-session-mutation'
import { getProfileUserDataPath } from '../capilot-profiles/profile-storage-paths'
import { isMultiProfileUiEnabled } from '../capilot-profiles/profile-ui-scope'
import { transferOrcaProfileProject } from '../capilot-profiles/profile-project-transfer'
import { findOrcaProfileProjectsByPath } from '../capilot-profiles/profile-project-presence'
import { flushActiveProfileBeforeFileMutation } from '../capilot-profiles/profile-persistence-deadline'
...
} from '../capilot-profiles/profile-cloud-service'
import { registerOrcaProfileOrgMemberHandlers } from './capilot-profile-org-members-handlers'
...
async function runBeforeProfileRelaunch(
  ...
  try {
    ...
    console.warn(
      '[capilot-profiles] Pre-relaunch cleanup failed; continuing profile switch:',
