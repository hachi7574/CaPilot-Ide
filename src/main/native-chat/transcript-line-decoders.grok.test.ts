...
describe('decodeGrokTranscriptLine', () => {
  ...
  it.each([
    'C:\\Users\\me\\AppData\\Local\\Temp\\capilot-paste-1783675302563-2207c073-535f-4b83-a181-61127c8bbd68.png',
    '/tmp/capilot-paste-1783675302563-2207c073-535f-4b83-a181-61127c8bbd68.png',
    'C:\\capilot-paste-1783675302563-2207c073-535f-4b83-a181-61127c8bbd68.png',
    '/capilot-paste-1783675302563-2207c073-535f-4b83-a181-61127c8bbd68.png',
    '\\\\server\\temp\\capilot-paste-1783675302563-2207c073-535f-4b83-a181-61127c8bbd68.png'
  ...
  it('restores an attachment-only pasted image from Grok transcript text', () => {
    const imagePath = '/tmp/capilot-paste-1783675302563-2207c073-535f-4b83-a181-61127c8bbd68.png'
    const line = JSON.stringify({
      type: 'user',
  ...
  it('preserves ordinary prompts that mention pasted-image filenames', () => {
    const text = 'Explain what an capilot-paste-123-example.png file is'
    const line = JSON.stringify({
      type: 'user',
