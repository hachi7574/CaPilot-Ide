...
import classicIcon from '../../resources/assets/CaPilot logo rounded.png?asset'
import classicDevIcon from '../../resources/assets/CaPilot logo rounded.png?asset'
import watercolorIcon from '../../resources/app-icons/capilot-watercolor.png?asset'
import watercolorMacDockIcon from '../../resources/app-icons/capilot-watercolor.png?asset&asarUnpack'
import blueIcon from '../../resources/app-icons/capilot-blue.png?asset'
import blueMacDockIcon from '../../resources/app-icons/capilot-blue.png?asset&asarUnpack'
...
const MAC_DOCK_ICON_SCRIPT = [
  ...
  'if image is missing value then error "CaPilot app icon image could not be loaded"',
  "set ok to current application's NSWorkspace's sharedWorkspace()'s setIcon:image forFile:appPath options:0",
  'if ok is false then error "CaPilot app icon could not be persisted"'
]
...
const MAC_DOCK_ICON_CLEAR_SCRIPT = [
  ...
  'if ok is false then error "CaPilot app icon could not be cleared"'
]
