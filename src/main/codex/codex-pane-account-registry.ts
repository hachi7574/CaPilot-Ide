 ...
 * across app restarts, so without an on-disk record CaPilot forgets a pane is on
...
// Why: bounds a file that only shrinks when CaPilot observes a PTY exit; a crash
