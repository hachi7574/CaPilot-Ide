...
// typed `omp` in an existing terminal still needs CaPilot's status extension
...
export function getPosixOmpShellWrapper(): string {
  ...
  return `# Why: OMP does not auto-load CaPilot's managed status extension; wrap only
