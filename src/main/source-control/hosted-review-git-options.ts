...
export type HostedReviewExecutionOptions = {
  ...
  /** Paths CaPilot may have symlinked into this worktree. An untracked entry that
   *  is one of these is CaPilot's own artifact, not work the user can commit, so it
