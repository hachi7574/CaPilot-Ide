...
// through CaPilot. Without a cap, a heavily-used instance accumulates thousands of
...
// after configureDevUserDataPath() but before app.setName('CaPilot'). See the
...
export function initStatsPath(): void {
  _statsFile = join(app.getPath('userData'), 'capilot-stats.json')
}
