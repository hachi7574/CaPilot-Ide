 ...
 * capilot-runtime.ts normalizeTerminalChunk but avoids importing the runtime.
 */
...
export class AgentDetector {
  ...
  /**
   * Called on every PTY data chunk (from capilot-runtime.ts onPtyData).
  ...
  /**
   * Called when a PTY process exits (from capilot-runtime.ts onPtyExit).
   */
