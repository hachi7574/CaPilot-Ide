 ...
 * process in the PTY tree, so an CaPilot "Codex" pane running a subagent reads as
 ...
 * recorded metadata (CaPilot started Codex in this tab), not a repaintable label,
