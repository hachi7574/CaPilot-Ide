...
export const EMULATOR_MANUAL_LAUNCH_STARTED_EVENT = 'capilot:emulator-launch-started'
export const EMULATOR_MANUAL_LAUNCH_FAILED_EVENT = 'capilot:emulator-launch-failed'
