export const ORCHESTRATION_SETUP_STATE_EVENT = 'capilot:orchestration-setup-state'
export const ORCHESTRATION_ENABLED_STORAGE_KEY = 'capilot.orchestration.enabled'
export const ORCHESTRATION_SETUP_DISMISSED_STORAGE_KEY = 'capilot.orchestration.setupDismissed'
