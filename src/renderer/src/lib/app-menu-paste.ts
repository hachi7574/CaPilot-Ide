...
export const APP_MENU_PASTE_EVENT = 'capilot-app-menu-paste'
...
export async function handleAppMenuPasteRequest({
  ...
  try {
    ...
    // control gained focus, not the text control CaPilot already resolved.
  ...
  // Why: for text controls CaPilot has already resolved ownership. Falling back
