 ...
 * PTY. TerminalTab.launchAgent records the harness CaPilot started; manually typed
...
function deriveTitleHintAgentTarget(
  ...
  if (!titleEvidence) {
    // Why: launchAgent is set the instant CaPilot spawns the tab, but the runtime
