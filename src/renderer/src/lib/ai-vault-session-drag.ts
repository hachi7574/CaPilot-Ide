...
export const AI_VAULT_SESSION_DRAG_TYPE = 'application/x-capilot-ai-vault-session'
export const AI_VAULT_SESSION_DRAG_START_EVENT = 'capilot-ai-vault-session-drag-start'
export const AI_VAULT_SESSION_DRAG_END_EVENT = 'capilot-ai-vault-session-drag-end'
...
export function writeAiVaultSessionDragData(
  ...
  // resume command instead of letting CaPilot's pane drop layer handle it.
