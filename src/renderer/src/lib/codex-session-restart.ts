...
export type CodexPaneScanResult = {
  ...
  /** CaPilot launched Codex in this tab, so a shell foreground can still be reattach settle. */
 ...
 * Gated to CaPilot-launched Codex panes so an account switch never spends the
 ...
 * baked into their environment. Without this, quitting CaPilot before restarting a
