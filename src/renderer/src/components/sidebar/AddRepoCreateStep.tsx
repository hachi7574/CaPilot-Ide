// Step for AddRepoDialog (capilot#763), split out so create-project state stays scoped.
      ...
      <DialogHeader>
        ...
        <DialogDescription>
          {translate(
            ...
            'Name it and CaPilot will create a real project with sensible defaults.'
          )}
        </DialogDescription>
      </DialogHeader>
