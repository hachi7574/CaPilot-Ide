...
describe('create project defaults', () => {
  it('builds the POSIX default project parent', () => {
    expect(getDefaultCreateProjectParent('/Users/alice')).toBe('/Users/alice/capilot/projects')
  })

  it('builds the Windows default project parent', () => {
    expect(getDefaultCreateProjectParent('C:\\Users\\alice')).toBe(
      'C:\\Users\\alice\\capilot\\projects'
    )
  })

  it('derives the runtime project default from a resolved server home', () => {
    expect(getDefaultCreateProjectParent('/home/alice')).toBe('/home/alice/capilot/projects')
  })

  it('joins path previews without mixing separators', () => {
    expect(joinCreateProjectPath('/home/alice/capilot/projects', 'demo')).toBe(
      '/home/alice/capilot/projects/demo'
    )
    expect(joinCreateProjectPath('C:\\Users\\alice\\capilot\\projects', 'demo')).toBe(
      'C:\\Users\\alice\\capilot\\projects\\demo'
    )
  })
  ...
  it('auto-fills only the first empty local create step', () => {
    ...
    ).toEqual({ parent: '/Users/alice/capilot/projects' })
    expect(
      getCreateProjectDefaultParentAutoFill({
        step: 'create',
  ...
  it('uses a short local summary only for the local default parent', () => {
    expect(
      formatCreateProjectParentSummary({
        parent: '/Users/alice/capilot/projects',
        defaultParent: '/Users/alice/capilot/projects'
      })
    ).toBe('~/capilot/projects')
    expect(
      formatCreateProjectParentSummary({
        parent: '',
        defaultParent: '',
    ...
    ).toBe('/Users/alice/capilot/projects')
    expect(
      formatCreateProjectParentSummary({
        parent: '',
        defaultParent: '',
