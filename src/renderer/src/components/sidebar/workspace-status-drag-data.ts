...
export const WORKSPACE_STATUS_DRAG_TYPE = 'application/x-capilot-worktree-id'
export const WORKSPACE_STATUS_DRAG_IDS_TYPE = 'application/x-capilot-worktree-ids'
