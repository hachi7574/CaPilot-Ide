...
function makeMarkerDecoration(
  ...
  return {
    ...
    options: {
      ...
      marginClassName: 'capilot-conflict-margin',
      hoverMessage: { value: label },
      linesDecorationsTooltip: label,
      after: {
        content: ` ${label}`,
        inlineClassName: 'capilot-conflict-marker-label'
      }
    }
  }
}
...
function makeSectionDecoration(
  ...
  return {
    ...
    options: {
      isWholeLine: true,
      className: `capilot-conflict-section-line capilot-conflict-${section}-line`
    }
  }
}
