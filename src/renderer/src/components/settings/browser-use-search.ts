...
export const getBrowserUsePaneSearchEntries = createLocalizedCatalog(() => [
  {
    title: translate('auto.components.settings.browser.use.search.50f0860e18', 'Enable CaPilot CLI'),
    ...
    keywords: [
      ...
      ...translateSearchKeyword('auto.components.settings.browser.use.search.ff05cbc344', 'capilot'),
  ...
  },
  {
    ...
    description: translate(
      ...
      "Install the Browser Use skill so agents can operate CaPilot's browser."
    ),
    keywords: [
      ...translateSearchKeyword(
        'auto.components.settings.browser.use.search.ba4eb53b72',
