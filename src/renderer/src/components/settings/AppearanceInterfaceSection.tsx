        ...
        <AppearanceAdvancedDisclosure showTopBorder={false}>
          <div className="divide-y divide-border/40">
            <SearchableSetting
              ...
              keywords={titlebarEntry?.keywords ?? ['titlebar', 'capilot', 'app', 'name']}
            >
              <SettingsSwitchRow
                label={translate(
                  'auto.components.settings.AppearancePane.9868f39007',
            ...
            {isDesktopWindows ? (
              ...
              >
                <SettingsSwitchRow
                  ...
                  // Why: platform constraint + "close keeps CaPilot running" consequence are
                  // both non-obvious from the label alone.
                  description={translate(
                    'auto.components.settings.AppearancePane.b707773a0d',
                    'When enabled, closing the window keeps CaPilot running in the system tray instead of quitting.'
                  )}
              ...
              >
                <SettingsSwitchRow
                  ...
                  description={translate(
                    ...
                    'Keep an CaPilot shortcut and activity indicator in the macOS menu bar.'
                  )}
