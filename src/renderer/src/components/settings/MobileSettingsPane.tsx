    ...
    <div className="space-y-4">
        ...
        <div className="space-y-2 text-xs text-muted-foreground">
          <p>
            {translate(
              ...
              'Install CaPilot Mobile from the'
            )}{' '}
            <button
              type="button"
      ...
      <SearchableSetting
        title={translate(
          ...
          'Show CaPilot Mobile Button'
        )}
        description={translate(
          'auto.components.settings.MobileSettingsPane.682293cadf',
          'Show the CaPilot Mobile button at the top of the left sidebar.'
        )}
      ...
      >
        ...
        <SettingsSwitchRow
          ...
          description={translate(
            ...
            'Show the CaPilot Mobile shortcut in the sidebar.'
          )}
