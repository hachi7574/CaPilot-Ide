...
function placement(
  ...
  return {
    ...
    unresolvedPath: '/home/.agents/skills/capilot-cli',
    resolvedPath: '/home/.agents/skills/capilot-cli',
    physicalIdentity: 'physical-capilot-cli',
...
const DISMISSAL_KEY = ['physical-capilot-cli', 'capilot-cli', '2'].join('\0')
    ...
    mocks.inventory = {
      ...
      installations: [
        ...
        placement({
          ...
          topology: 'repo-scope',
          sourceKind: 'repo',
          unresolvedPath: '/home/projects/work/.agents/skills/capilot-cli',
          resolvedPath: '/home/projects/work/.agents/skills/capilot-cli',
          physicalIdentity: 'physical-repo-capilot-cli'
        })
      ],
      eligibleUpdateNames: ['capilot-cli'],
      scanIssues: [],
    ...
    mocks.inventory = {
      ...
      installations: [
        ...
        placement({
          ...
          topology: 'repo-scope',
          sourceKind: 'repo',
          physicalIdentity: 'physical-repo-capilot-cli-after-checkout'
        })
      ],
      eligibleUpdateNames: ['capilot-cli'],
      scanIssues: [],
