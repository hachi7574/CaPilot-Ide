...
const sections: SettingsNavSection[] = [
  {
    ...
    searchEntries: [
      {
        title: 'CaPilot CLI',
        description: 'Register or remove the capilot shell command.',
  ...
  {
    id: 'servers',
    title: 'Remote CaPilot Servers',
    description: 'Pair remote CaPilot runtimes.',
    icon: Settings,
    searchEntries: [{ title: 'Remote CaPilot Servers' }],
    group: 'remote'
  },
  {
    id: 'ssh',
...
describe('Cmd+J palette middle-band ranking', () => {
  it.each([
    ...
    ['capilot cli', 'settings:general:cli'],
