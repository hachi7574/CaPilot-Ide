...
export function DiffCommentPopover({
  ...
  return (
    <div
      ref={popoverRef}
      className="capilot-diff-comment-popover"
    ...
    >
      {/* Content */}
      <div className="capilot-diff-comment-content-col" style={{ gap: '8px' }}>
        <div id={labelId} className="capilot-diff-comment-popover-label">
          {title ??
