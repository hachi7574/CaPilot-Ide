...
} from './capilot-profile-switch-liveness'
  ...
  it('filters live work to the selected project', () => {
    const summary = getOrcaProfileProjectLiveWorkSummary(
      makeState({
        ...
        browserTabsByWorktree: {
          'repo-1::/workspace/capilot': [makeBrowserWorkspace('browser-1')],
        ...
        tabsByWorktree: {
          'repo-1::/workspace/capilot': [makeTab({ id: 'tab-live', title: 'Codex working' })],
