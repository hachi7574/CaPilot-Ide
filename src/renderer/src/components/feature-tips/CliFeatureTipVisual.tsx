...
const CLI_AGENT_COMMANDS = [
  'capilot worktree create --name auth-pr-1',
  'capilot worktree create --name auth-pr-2',
  'capilot orchestration dispatch --task pr1 --to w1',
  'capilot orchestration dispatch --task pr2 --to w2'
]
