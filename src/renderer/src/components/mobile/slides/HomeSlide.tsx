      ...
      <div className="mp-app-topbar">
        <div className="mp-app-brand">
          ...
          <span className="mp-app-brand-name">
            {translate('auto.components.mobile.slides.HomeSlide.5d94e8ddcc', 'CaPilot')}
          </span>
        </div>
        <button
          type="button"
...
function OrcaLogo(): React.JSX.Element {
  return (
    <svg className="mp-capilot-logo" viewBox="0 0 318.60232 202.66667" fill="currentColor" aria-hidden>
