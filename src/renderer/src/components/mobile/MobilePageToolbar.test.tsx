...
describe('MobilePageToolbar', () => {
  it('labels the sidebar toggle explicitly when CaPilot Mobile is visible in the sidebar', () => {
    ...
    expect(html).not.toContain('Remove CaPilot Mobile')
  })

  it('labels the restore action explicitly when CaPilot Mobile is hidden from the sidebar', () => {
    const html = renderToStaticMarkup(
      <MobilePageToolbar
