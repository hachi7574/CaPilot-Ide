...
const FEATURE_SETUP_ROWS: readonly FeatureSetupRow[] = [
  {
    ...
    setupSummary: 'Enables browser use, prepares capilot-cli, and leaves cookies for Settings.',
  ...
  },
  {
    ...
    setupSummary: 'Registers the CaPilot CLI, opens permissions, and prepares the skill.',
  ...
  },
  {
    ...
    setupSummary: 'Registers the CaPilot CLI, enables orchestration, and prepares the skill.',
