...
describe('shellEscapePath', () => {
  ...
  it('keeps safe Windows paths unquoted', () => {
    expect(shellEscapePath('C:\\Users\\capilot\\file.txt', 'windows')).toBe(
      'C:\\Users\\capilot\\file.txt'
    )
  })

  it('double-quotes Windows paths with spaces', () => {
    expect(shellEscapePath('C:\\Users\\capilot\\my file.txt', 'windows')).toBe(
      '"C:\\Users\\capilot\\my file.txt"'
    )
  })

  it('double-quotes Windows paths with cmd separators', () => {
    expect(shellEscapePath('C:\\Users\\capilot\\a&b.txt', 'windows')).toBe(
      '"C:\\Users\\capilot\\a&b.txt"'
    )
  })
  ...
  it('uses POSIX escaping for SSH drops regardless of client OS', () => {
    ...
    expect(shellEscapePath("/home/u/wt/.capilot/drops/my file's $draft.txt", 'posix')).toBe(
      "'/home/u/wt/.capilot/drops/my file'\\''s $draft.txt'"
    )
  })
})
