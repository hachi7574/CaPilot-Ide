...
// Mac-style terminal traffic-light dots — the signature of an CaPilot terminal pane.
...
// Use CaPilot's browser: a browser pane with a cursor grabbing one highlighted
