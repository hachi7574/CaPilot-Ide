...
// Why: this animation tells the full CaPilot story end-to-end — the user opens a
...
// CaPilot's dropdown/popover primitives while staying inside the storyboard DOM.
