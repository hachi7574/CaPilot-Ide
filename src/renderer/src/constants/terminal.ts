...
export const TOGGLE_TERMINAL_PANE_EXPAND_EVENT = 'capilot-toggle-terminal-pane-expand'
export const FOCUS_TERMINAL_PANE_EVENT = 'capilot-focus-terminal-pane'
export const PASTE_TERMINAL_TEXT_EVENT = 'capilot-paste-terminal-text'
export const SPLIT_TERMINAL_PANE_EVENT = 'capilot-split-terminal-pane'
export const REQUEST_ACTIVE_TERMINAL_PANE_SPLIT_EVENT = 'capilot-request-active-terminal-pane-split'
export const CLOSE_TERMINAL_PANE_EVENT = 'capilot-close-terminal-pane'
export const BACKGROUND_MOUNT_TERMINAL_WORKTREE_EVENT = 'capilot-background-mount-terminal-worktree'
...
export const WAKE_HIBERNATED_AGENTS_WORKTREE_EVENT = 'capilot-wake-hibernated-agents-worktree'
...
export const SYNC_FIT_PANES_EVENT = 'capilot-sync-fit-panes'
