...
Engage CaPilot's computer-use surface whenever you must inspect or operate a local desktop app
...
windows, webviews, and CaPilot's own UI. Triggers include "computer use", "capilot computer",
