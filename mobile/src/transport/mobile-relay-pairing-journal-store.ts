...
const JOURNAL_STORAGE_KEY = 'capilot:mobile-relay:pairing-journal:v1'
const JOURNAL_SECRET_KEY = 'capilot.mobile-relay.pairing-journal.v1'
...
function requireNativeSecretStore(): void {
  if (Platform.OS === 'web') {
    throw new Error('CaPilot Relay pairing requires a native secret store')
  }
}
