...
const PINS_PREFIX = 'capilot:pins:'
const NOTIF_KEY = 'capilot:pushNotificationsEnabled'
...
const TEXT_SCALE_KEY = 'capilot:terminalTextScale'
...
const AUTOCOMPLETE_KEY = 'capilot:terminalAutocompleteEnabled'
...
const TERMINAL_LIVE_INPUT_DISABLED_PREFIX = 'capilot:terminalLiveInputDisabled:'
...
const SIDEBAR_WIDTH_KEY = 'capilot:hostSidebarWidth'
...
const DOCK_WIDTH_KEY = 'capilot:hostDockWidth'
...
export type MobileTerminalLinkOpenMode = 'capilot-browser' | 'phone-browser'

const TERMINAL_LINK_OPEN_MODE_KEY = 'capilot:terminalLinkOpenMode'
export const DEFAULT_TERMINAL_LINK_OPEN_MODE: MobileTerminalLinkOpenMode = 'capilot-browser'
...
export async function loadTerminalLinkOpenMode(): Promise<MobileTerminalLinkOpenMode> {
  try {
    ...
    return raw === 'phone-browser' || raw === 'capilot-browser' ? raw : DEFAULT_TERMINAL_LINK_OPEN_MODE
  } catch {
