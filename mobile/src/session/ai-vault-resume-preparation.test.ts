...
const LEGACY_CODEX_HOME = '/Users/ada/Library/Application Support/capilot/codex-runtime-home/home'
const PER_ACCOUNT_HOME = '/Users/ada/Library/Application Support/capilot/codex-accounts/a/home'
...
describe('prepareMobileAiVaultSessionResume', () => {
  ...
  it('repins a per-account session to the home the host substitutes', async () => {
    const substituteHome = '/Users/ada/Library/Application Support/capilot/codex-accounts/b/home'
