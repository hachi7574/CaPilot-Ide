...
export const troubleshootCommonIssues: TroubleshootSection[] = [
  ...
  },
  {
    ...
    steps: [
      'macOS: System Settings → Network → Firewall — allow CaPilot.',
      'Windows: Defender Firewall → Allow app — enable CaPilot for Private networks.',
  ...
  },
  {
    ...
    steps: [
      'CaPilot must be open on your desktop to accept connections.',
      'Try restarting CaPilot — the companion server starts on launch.',
