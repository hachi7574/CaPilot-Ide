...
// The repo-owned capilot.yaml setup-hook trust prompt, shown before a workspace
        ...
        <View>
          <View style={styles.trustHeader}>
            ...
            <Text style={styles.subtitle}>
              This repository's capilot.yaml runs before the workspace starts. Only run it if you trust
              this repository.
            </Text>
          </View>
