...
export default function PairScanScreen() {
  ...
  const handleBarCodeScanned = useCallback(
    ({ data }: { data: string }) => {
      ...
      if (!offer) {
        setStatus('error')
        setErrorMessage('Not a valid CaPilot QR code')
      ...
      <View ref={setPairScanRootRef} style={[styles.container, containerPadding]}>
        ...
        <View style={styles.centered}>
          ...
          <Text style={styles.subtitle}>
            {canAskAgain
              ? 'Scan the QR code from CaPilot on your desktop, or paste the pairing code instead.'
  ...
  return (
    <View ref={setPairScanRootRef} style={[styles.container, containerPadding]}>
      ...
      <View style={styles.steps}>
        <Step number={1} text="Open CaPilot on your computer" />
