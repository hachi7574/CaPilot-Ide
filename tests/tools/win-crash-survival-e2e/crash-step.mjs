...
//
// GitHub #7742: when CaPilot's main/renderer process died on Windows, the terminal
 ...
 * or image-named process, so a live user CaPilot on the same box is never touched.
 */
