...
const REMOTE_TUI_PATH = '/tmp/capilot-codex-display-artifacts-repro.mjs'
...
await write('If CaPilot leaves wide gray rectangles here, they are stale remote-PTY render artifacts.\\r\\n')
...
await write('Tip: deterministic fixture for CaPilot SSH Codex display artifacts.\\r\\n\\r\\n')
