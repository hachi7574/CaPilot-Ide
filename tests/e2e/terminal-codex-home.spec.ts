...
test.describe('Terminal Codex runtime home', () => {
  ...
  test('terminal process receives the CaPilot-managed Codex home', async ({ orcaPage }) => {
    ...
    await expect
      .poll(
        ...
        { timeout: 15_000, message: 'Terminal did not expose CaPilot-managed Codex home env' }
      )
      .toBe(true)
