...
import { expect } from './capilot-app'
...
// CaPilot's own add/remove path — the one thing that invalidates the main-process
 ...
 * raw `git worktree add` that CaPilot never observed still becomes visible.
 */
